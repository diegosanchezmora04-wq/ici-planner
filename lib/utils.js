function calcularInicioSemestre() {
  const hoy  = new Date();
  ...
  // Semestre 1: enero-julio → primer lunes de marzo
  // Semestre 2: agosto-diciembre → primer lunes de agosto
  return mes <= 7
    ? primerLunes(anio, 3)
    : primerLunes(anio, 8);
}

export const SEM_START = calcularInicioSemestre();
export const WEEKS     = 19;
export const COLORS    = [
